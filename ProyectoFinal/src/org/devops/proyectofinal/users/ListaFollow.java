...
public class ListaFollow extends BaseAdapter {
	...
	public ListaFollow(Activity actividad, Vector<Usuario> lista, Context c) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view = inflater.inflate(R.layout.lista_follow, null, true);
